...
$smarty->assign('prompt_enable_whitelist',
		$this->Lang('enable_whitelist'));
$smarty->assign('input_enable_whitelist',
		$this->CreateInputDropdown($id,
					   'input_enable_whitelist', $ary, -1,
					   $this->GetPreference('enable_whitelist', '')));

$smarty->assign('prompt_whitelist',
		$this->Lang('whitelist'));
...
$smarty->assign('prompt_whitelist_trigger_message',
		$this->Lang('whitelist_trigger_message'));
$smarty->assign('input_whitelist_trigger_message',
		$this->CreateInputText($id,
				       'input_whitelist_trigger_message',
				       $this->GetPreference('whitelist_trigger_message', ''),
				       50));

$smarty->assign('input_reg_additionalgroups',
		$this->CreateInputYesNoDropdown($id,'input_reg_additionalgroups',
...
$smarty->assign('additionalgroups_matchfields',
		explode('::',$this->GetPreference('additionalgroups_matchfields')));


$smarty->assign('input_allowselectpkg',
...
if( $cgecb )
  {
    $smarty->assign('input_allowpaidregistration',
		    $this->CreateInputYesNoDropdown($id,'allowpaidregistration',
						    $this->GetPreference('allowpaidregistration',0)));

    $smarty->assign('cartitem_summary_tpl',
		    $this->GetPreference('cartitem_summary_tpl'));

    $smarty->assign('redirect_paidpkg',
		    $this->GetPreference('redirect_paidpkg',''));
  }
