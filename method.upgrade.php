...

{
  ...
  switch( $oldversion )
	...
	$sqlarray = $dict->AddcolumnSQL(cms_db_prefix()."module_selfreg_users",
					"overwrite_uid I");
	...
	$flds = 'id I AUTO KEY,
                 ...
                 subscr_type C(10),
                 cost F';
	$sqlarray = $dict->CreateTableSQL(cms_db_prefix().'module_selfreg_paidpkgs',
					  $flds,$taboptarray);
	$dict->ExecuteSQLArray($sqlarray);

	$this->SetTemplate('selpkgtemplate',
			   @file_get_contents(dirname(__FILE__).'/templates/orig_selpkg_template.tpl'));
